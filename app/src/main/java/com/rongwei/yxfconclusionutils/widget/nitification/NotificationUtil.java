package com.rongwei.yxfconclusionutils.widget.nitification;
...
import com.rongwei.yxfconclusionutils.MainActivity;
...
public class NotificationUtil {
     ...
     * @param context 上下文
     */
    public static void showNotification(Context context,String title,String ticker,String content) {
...
//                .setContentIntent(PendingIntent.getActivity(context, 1, new Intent(context, MainActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
     ...
     * @param context
     */
    public static void shwoNotify(Context context,String title,String ticker,String content) {
        //先设定RemoteViews
