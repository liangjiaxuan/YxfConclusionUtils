...
public class AnimationAdapter extends BaseQuickAdapter<AnimationItem,BaseViewHolder> {

    public AnimationAdapter(@LayoutRes int layoutResId, @Nullable List<AnimationItem> data) {
