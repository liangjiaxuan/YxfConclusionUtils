...
public class SSLUtils {
    ...
    public static SSLParams getSslSocketFactory(X509TrustManager trustManager) {
        return getSslSocketFactory(null, null, trustManager);
    }
    ...
    public static SSLParams getSslSocketFactory(InputStream bksFile, String password, X509TrustManager trustManager) {
        return getSslSocketFactory(trustManager, bksFile, password, null);
    }

    private static SSLParams getSslSocketFactory(X509TrustManager trustManager, InputStream bksFile, String password, InputStream[] certificates) {
        ...
        try {
            ...
            // TLS建立在SSL 3.0协议规范之上，是SSL 3.0的后续版本。两者差别极小，可以理解为SSL 3.1，它是写入了RFC的。
